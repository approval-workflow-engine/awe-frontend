...
import { Box, Typography, IconButton, Button, Chip, Snackbar } from '@mui/material';
...
export default function ScriptTaskEditorPanel({ node, onUpdateConfig, onClose }: ScriptTaskEditorPanelProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Typography sx={{ fontSize: 12, fontWeight: 600, color: 'text.primary', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          {node.label}
        </Typography>
        ...
        <Button
          ...
          sx={{
            fontSize: 11, height: 26, borderRadius: '6px',
      ...
      {codeMode === 'file' && attachedFileName && (
        ...
        >
          ...
          <Typography sx={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: 'text.secondary', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {attachedFileName}
          </Typography>
          {isEdited && (
            <Chip
      ...
      <Box sx={{ flex: 1, overflow: 'hidden' }}>
        <Editor
          ...
          value={sourceCode}
          onChange={value => onUpdateConfig({ ...node.config, sourceCode: value ?? '' })}
          options={{
            fontSize: 12,
            fontFamily: "'JetBrains Mono', monospace",
