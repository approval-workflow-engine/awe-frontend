...
import { type WorkflowInput } from "./type/types";
...
export default function InputsDialog({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle
        sx={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 16 }}
      >
        Workflow Inputs
      </DialogTitle>
      <DialogContent sx={{ pt: "8px !important" }}>
        <Typography sx={{ fontSize: 12, color: "text.secondary", mb: 2 }}>
          Define the input variables that every new instance of this workflow
          must provide.
        </Typography>
            ...
            {inputs.map((input, i) => (
              ...
              >
                ...
                <Select
                  ...
                  onChange={(e) =>
                    updateInput(i, {
                      type: e.target.value as WorkflowInput["type"],
                    })
                  }
                ...
                <IconButton
                  ...
                  sx={{ color: "#ef4444", p: 0.25, flexShrink: 0 }}
                >
