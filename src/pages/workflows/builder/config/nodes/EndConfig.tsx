...
export default function EndConfig({
  ...
  const updateRow = (idx: number, patch: Partial<ResultMapRow>) =>
    set(
      "resultMap",
      resultMap.map((r, i) => (i === idx ? { ...r, ...patch } : r)),
    );
        ...
        <Box display="flex" flexDirection="column" gap={0.75}>
            ...
            >
              ...
              >
                <Box display="flex" alignItems="center" gap={0.5}>
                  ...
                  <Tooltip
                    title={
                      expanded.has(idx) ? "Collapse" : "Validation expression"
                    }
                  >
                    <IconButton
                      size="small"
          ...
          <AddRowButton
            ...
            onClick={() =>
              set("resultMap", [
                ...resultMap,
                { contextVariable: EMPTY_CV, valueExpression: "" },
              ])
            }
          />
        </Box>
